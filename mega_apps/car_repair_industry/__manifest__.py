...

{
    "name": "Mega - Taller",
    "version": "1.0",
    "depends": ['base', 'sale', 'purchase', 'account', 'sale_stock', 'mail', 'product', 'stock', 'fleet','sale_management', 'website', 'calendar', 'hr_timesheet','web', 'mega_sale_order_business_fields'],
    ...
    "data": [
        ...
        'data/fleet_repair_spare_catalog_data.xml',
        'data/fleet_repair_branch_data.xml',
        'data/data.xml',
        ...
        'wizard/fleet_repair_road_test_request_wizard_view.xml',
        ...
        'views/fleet_repair_spare_views.xml',
