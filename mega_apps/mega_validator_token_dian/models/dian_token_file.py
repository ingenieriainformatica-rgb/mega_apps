...
class MegaDianTokenFile(models.Model):
    ...
    partner_id = fields.Many2one("res.partner", string="Proveedor encontrado", readonly=True)
    move_id = fields.Many2one("account.move", string="Factura Odoo", readonly=True)
