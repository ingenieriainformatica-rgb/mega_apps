...
class StockPicking(models.Model):
    ...
    l10n_latam_document_type_id = fields.Many2one(comodel_name="l10n_latam.document.type", string="Document Type (UY)", copy=False)
    ...
    l10n_uy_edi_operation_type = fields.Selection(
        ...
        compute="_compute_l10n_uy_edi_operation_type",
        inverse="_inverse_l10n_uy_edi_operation_type",
        store=True,
        copy=False,
    )
    ...
    # Compute methods
    @api.onchange("l10n_uy_edi_operation_type")
    @api.depends("l10n_latam_available_document_type_ids")
    def _compute_l10n_uy_edi_operation_type(self):
        for picking in self:
    ...
    def _inverse_l10n_uy_edi_operation_type(self):
        pass
